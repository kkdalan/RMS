...
from Issue.views import index, add_issue, edit_issue, del_issue, notfound, issue_list

urlpatterns = [
    url(r'^admin/',include(admin.site.urls)),
    url(r'^$', auth_views.login, { 'authentication_form':AuthenticationForm } ,name='login'),
